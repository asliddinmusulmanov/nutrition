...
import "../../vm/food_details_vm.dart";
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return PopupMenuButton<String>(
                  ...
                  Center(
                    child: Consumer(
                      builder: (BuildContext context, WidgetRef ref, Widget? child) => MaterialButton(
                        ...
                        elevation: 0,
                        color: ref.watch(foodDetailsProvider).rating > 0 ? AppColors.cFFAD30 : AppColors.cD9D9D9,
                        height: 28.h,
                        minWidth: 80.w,
      ...
      itemBuilder: (BuildContext context) => <PopupMenuEntry<String>>[
        ...
        if (foodDetailsVM.saveFood)
          PopupMenuItem<String>(
            value: "unsave",
            child: ListTile(
              leading: SvgPicture.asset(
                Assets.iconsRecipeUnsaveIcon,
                // ignore: deprecated_member_use
                color: context.theme.colorScheme.onSurface,
              ),
